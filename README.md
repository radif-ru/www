...
| `#stands`              | контуры разработки: тестовые стенды на каждого, stage, приёмка                                                  |
...
| `#integrations`        | воронка и девять интеграций: Битрикс24, Albato, GetCourse, Tilda, Марквиз, Метрика, eLama, RIS.Promo, ВКонтакте |
