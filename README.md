...
[![repo size](https://img.shields.io/github/repo-size/radif-ru/www)](https://github.com/radif-ru/www)
[![code size](https://img.shields.io/github/languages/code-size/radif-ru/www)](https://github.com/radif-ru/www)
...
- `files/screenshots/` — WebP-скриншоты демо мульти-агентной системы (превью `*-thumb.webp`
  и полные версии), источник — `docs/screenshots/` репозитория `ai-multi-agent-system`.
